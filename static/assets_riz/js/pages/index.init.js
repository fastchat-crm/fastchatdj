var options = {
        ...
        yaxis: {
            labels: {
                offsetX: -12, offsetY: 0, formatter: function (e) {
                    return "$" + e
                }
            }
        },
    ...
    }, chart = new ApexCharts(document.querySelector("#audience_overview"), options), options = (chart.render(), {
        ...
        fill: {
            ...
            gradient: {
                ...
                opacityFrom: .7,
                opacityTo: 1,
                colorStops: [{offset: 0, color: "rgba(106, 155, 155, 0.4)", opacity: 1}, {
                    offset: 100,
