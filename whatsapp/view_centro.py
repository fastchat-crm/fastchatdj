        ...
        'fases': [
            ...
            },
            {
                ...
                'modulos': [
                    ...
                    {'nombre': 'Tarifas Meta y consumo', 'url': '/whatsapp/tarifas/', 'icono': 'fa fa-coins', 'nivel': 'avanzado',
                     'para_que': 'Registrar los precios por país/categoría, simular el costo de envíos masivos y ver el consumo real de plantillas: total, mes actual, por origen y por número (con link al gasto facturado en Meta).',
                     'cuando': 'Antes de lanzar campañas grandes por API oficial, y cada mes para controlar cuánto gasta cada número.'},
                ],
            },
            {
            ...
            },
            {
                ...
                'modulos': [
                    ...
                    {'nombre': 'Trazas / Logs', 'url': '/whatsapp/trazas/', 'icono': 'fa fa-bug', 'nivel': 'avanzado',
                     'para_que': 'El detective: timeline completo de cada mensaje por el pipeline (webhook → IA → envío) con errores y tokens. También accesible con el botón "Trazas" dentro de cada conversación.',
                     'cuando': 'Cuando algo no respondió y necesitas saber exactamente por qué.'},
                    {'nombre': 'Monitoreo webhook', 'url': '/whatsapp/monitoreo/', 'icono': 'fa fa-heart-pulse', 'nivel': 'avanzado',
                     'para_que': 'Auditoría de cada webhook que Meta envía al canal WhatsApp: firma, procesamiento, errores y payload completo.',
                     'cuando': 'Cuando sospechas que Meta envía eventos pero el sistema no los procesa (firma inválida, config faltante).'},
                ],
            },
        ],
    },
        ...
        'fases': [
            ...
            },
            {
                ...
                'modulos': [
                    ...
                    {'nombre': 'Supervisión', 'url': '/whatsapp/supervision/', 'icono': 'fa fa-eye', 'nivel': 'recomendado',
                     'para_que': 'El mismo monitor de asesores y esperas de WhatsApp cubre las sesiones de Instagram — filtra por la sesión IG.',
                     'cuando': 'Para líderes de equipo con atención multicanal.'},
            ...
            },
            {
                ...
                'modulos': [
                    ...
                    {'nombre': 'Analytics', 'url': '/whatsapp/analytics/', 'icono': 'fa fa-chart-line', 'nivel': 'recomendado',
                     ...
                     'cuando': 'Revisión semanal.'},
                    {'nombre': 'Supervisión', 'url': '/whatsapp/supervision/', 'icono': 'fa fa-eye', 'nivel': 'recomendado',
                     'para_que': 'El mismo monitor de asesores y esperas de WhatsApp cubre las sesiones de Messenger — filtra por la página conectada.',
                     'cuando': 'Para líderes de equipo con atención multicanal.'},
        ...
        'fases': [
            ...
            },
            {
                ...
                'modulos': [
                    ...
                    {'nombre': 'Analytics', 'url': '/whatsapp/analytics/', 'icono': 'fa fa-chart-line', 'nivel': 'recomendado',
                     'para_que': 'Las métricas incluyen el canal de origen — filtra conversaciones y leads que lleguen por TikTok.',
                     'cuando': 'Revisión semanal, cuando el canal esté activo.'},
                    {'nombre': 'Supervisión', 'url': '/whatsapp/supervision/', 'icono': 'fa fa-eye', 'nivel': 'recomendado',
                     'para_que': 'El mismo monitor de asesores y esperas cubre las sesiones TikTok — filtra por la cuenta conectada.',
                     'cuando': 'Para líderes de equipo con atención multicanal.'},
